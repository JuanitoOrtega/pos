          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <div class="input-group date">
                ...
                <!-- <input type="text" class="form-control input-lg datepicker" name="editarFechaNacimiento" placeholder="Ingresar fecha de nacimiento" required> -->
        ...
        <div class="modal-body">
          <div class="box-body">
            ...
            <div class="form-group">
              <div class="input-group date">
                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                <input type="text" class="form-control input-lg datepicker" name="editarFechaNacimiento" id="editarFechaNacimiento" required>
                <!-- <input type="date" class="form-control input-lg" name="editarFechaNacimiento" id="editarFechaNacimiento" data-inputmask="'alias':'yyyy/mm/dd'" data-mask required> -->
              </div>
            </div>
