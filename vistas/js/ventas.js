...
$(".tablaVentas tbody").on("click", "button.agregarProducto", function(){
  ...
  $.ajax({
    ...
    success:function(respuesta){
      ...
      /*==============================================
      EVITAR AGREGAR PRODUCTO CUANDO NO HAY STOCK
      ==============================================*/
      ...
      listarProductos();
      // FORMATO PARA EL PRECIO DE LOS PRODUCTOS
...
/*==============================================
QUITAR PRODUCTO DE LA VENTA Y RECUPERAR BOTÓN
==============================================*/
        ...
        '<div class="row" style="padding:5px 15px">'+
          ...
          '<div class="col-xs-6" style="padding-right:0px">'+
            '<div class="input-group">'+
              ...
              '<select class="form-control nuevaDescripcionProducto" idProducto id="producto'+numProducto+'" name="nuevaDescripcionProducto" required>'+
          ...
          '<div class="col-xs-3 ingresoCantidad">'+
            '<input type="number" class="form-control nuevaCantidadProducto" name="nuevaCantidadProducto" min="1" value="1" nuevoStock required>'+
          '</div>'+
...
$(".formularioVenta").on("change", "input.nuevaCantidadProducto", function(){
  ...
  if(Number($(this).val()) > Number($(this).attr("stock"))){
    ...
    swal({
      ...
      text: "¡Sólo hay "+$(this).attr("stock")+" unidad(es)!",
      type: "error",
      confirmButtonText: "¡Cerrar!"
    })
  }
...
$(".tablas").on("click", ".btnImprimirFactura", function(){
  ...
  window.open("../pos/extensiones/tcpdf/pdf/factura.php?codigo="+codigoVenta, "_blank");
})
